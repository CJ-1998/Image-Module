...
public class ConvertService {
    ...
    public ConvertService(MinioClient minioClient, DataClient dataClient,
                          KafkaTemplate<String, SendKafkaMessage> kafkaTemplate) {
    ...
    public void removeMetadataAndCovertWebP(OriginalImageResponse originalImage) {
        ...
        // 6. 원본 이미지 cdnUrl 추가
        OriginalFileInfo originalFileInfo = OriginalFileInfo.createCdnUrl(storedFileName);
